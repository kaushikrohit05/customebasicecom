...
<html lang="en">
  ...
  <?php include('includes/top.php'); ?>
    ...
    <div class="row">
    <div class="col-xs-6"><h3 class="title">Dashboard</h3></div>
    <div  class="col-xs-6 text-right"  ><a href="billing_shipping.php?businessid=<?php echo $row['id'];?>"  class="btn btn-sm btn-success" role="button"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Add User</a></div>
    </div>
<div class="row">
